    ...
    render() {
        ...
        return (
            <>
                ...
                <div 
                className={
                    this.props.show ? "modal-block-content__for-modal-order modal-block-opened" 
                                    : "modal-block-content__for-modal-order modal-block-closed"
                    }
                style={{ 
...
export default React.memo(withRouter(withTranslation()(ModalOrder)));